...
3. Update the existing or create a new key named `fvnever.dotnet-authors.github` with a permission to **Push only new package versions** and only allowed to publish the package **FVNever.DotNetAuthors**.
...
[github.secrets]: https://github.com/ForNeVeR/dotnet-authors/settings/secrets/actions
